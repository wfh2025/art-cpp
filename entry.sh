...
function build-libressl() {
    ...
    local src="${PROJ_ROOT}/vendor/libressl-4.2.1"
...
function build-oatpp() {
    ...
    local src="${PROJ_ROOT}/vendor/oatpp-1.3.1"
...
function build-folly() {
    ...
    local src="${PROJ_ROOT}/vendor/folly-2026.01.05.00"
...
function build-aws-sdk-cpp() {
    ...
    local src="${PROJ_ROOT}/vendor/aws-sdk-cpp"
...
function build-zlog() {
    ...
    local src="${PROJ_ROOT}/vendor/zlog-1.2.18"
...
function build-eigen() {
    ...
    local src="${PROJ_ROOT}/vendor/eigen-5.0.1"
...
function build-libevent() {
    ...
    local src="${PROJ_ROOT}/vendor/libevent-release-2.1.12-stable"
...
function build-zlib() {
    ...
    local src="${PROJ_ROOT}/vendor/zlib-1.3.1"
...
function build-civetweb() {
    ...
    local src="${PROJ_ROOT}/vendor/civetweb-1.16"
...
function build-leveldb() {
    ...
    local src="${PROJ_ROOT}/vendor/leveldb-1.23"
...
function build-nlohmann-json() {
    ...
    local src="${PROJ_ROOT}/vendor/json-3.12.0"
...
function build-abseil-cpp() {
    ...
    local src="${PROJ_ROOT}/vendor/abseil-cpp-20250814.1"
...
function build-linenoise-ng() {
    ...
    local src="${PROJ_ROOT}/vendor/linenoise-ng-1.0.1"
...
function build-dlib() {
    ...
    local src="${PROJ_ROOT}/vendor/dlib-20.0"
...
function build-fmt() {
    ...
    local src="${PROJ_ROOT}/vendor/fmt-12.0.0"
...
function build-gflags() {
    ...
    local src="${PROJ_ROOT}/vendor/gflags-2.2.2"
...
function build-pugixml() {
    ...
    local src="${PROJ_ROOT}/vendor/pugixml-1.15"
...
function build-poco() {
    ...
    local src="${PROJ_ROOT}/vendor/poco-poco-1.14.2-release"
...
function build-opencv() {
    ...
    local src="${PROJ_ROOT}/vendor/opencv-4.12.0"
    local src_contrib="${PROJ_ROOT}/vendor/opencv_contrib-4.12.0/modules"
